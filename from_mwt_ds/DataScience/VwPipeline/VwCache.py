...
class VwCache:
    ...
    def get_rel_path(self, opts_in: dict, opt_out: str = None, salt: str = None, logger = Logger.ConsoleLogger()) -> str:
    ...
    def get_path(self, opts_in: dict, opt_out: str = None, salt: str = None, logger = Logger.ConsoleLogger()) -> str:
